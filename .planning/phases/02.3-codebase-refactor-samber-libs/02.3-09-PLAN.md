...
Purpose: With samber libraries integrated, the codebase is cleaner. Now increase linter strictness to catch future issues. Use patterns from Plan 08 agents/skills to identify and fix remaining tech debt (long functions, god objects, inconsistent patterns).
...
# Samber skills for refactoring patterns
@.claude/skills/samber-lo.md
@.claude/skills/samber-mo.md

# Pattern skills for tech debt resolution
